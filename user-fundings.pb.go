...
type Wallet struct {
	...
	RegisteredSmartContracts []string               `protobuf:"bytes,6,rep,name=RegisteredSmartContracts,proto3" json:"RegisteredSmartContracts,omitempty"` // List of smart contract addresses registered to this wallet address
...
const file_user_fundings_proto_rawDesc = "" +
	"\n" +
	"\x13user-fundings.proto\x12\x04user\x1aIsologenic/com-fs-utils-lib/models/order-properties/order-properties.proto\"\xf2\x01\n" +
	"\x06Wallet\x12\x18\n" +
	...
	"\x18RegisteredSmartContracts\x18\x06 \x03(\tR\x18RegisteredSmartContracts\"\xcf\x01\n" +
	"\vBankAccount\x12 \n" +
