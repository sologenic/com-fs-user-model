...
const (
	...
	AdminUserService_GetByAddresses_FullMethodName = "/user.AdminUserService/GetByAddresses"
)
...
type AdminUserServiceClient interface {
	...
	GetByAddresses(ctx context.Context, in *GetByAddressesRequest, opts ...grpc.CallOption) (*GetByAddressesResponse, error)
}
...
func (c *adminUserServiceClient) GetByAddresses(ctx context.Context, in *GetByAddressesRequest, opts ...grpc.CallOption) (*GetByAddressesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetByAddressesResponse)
	err := c.cc.Invoke(ctx, AdminUserService_GetByAddresses_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdminUserServiceServer interface {
	...
	GetByAddresses(context.Context, *GetByAddressesRequest) (*GetByAddressesResponse, error)
}
...
func (UnimplementedAdminUserServiceServer) GetByAddresses(context.Context, *GetByAddressesRequest) (*GetByAddressesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetByAddresses not implemented")
}
...
func _AdminUserService_GetByAddresses_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetByAddressesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminUserServiceServer).GetByAddresses(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminUserService_GetByAddresses_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminUserServiceServer).GetByAddresses(ctx, req.(*GetByAddressesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AdminUserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetByAddresses",
			Handler:    _AdminUserService_GetByAddresses_Handler,
		},
	},
