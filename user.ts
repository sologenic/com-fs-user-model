    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 34:
          ...
          message.ReferralAmountReceived = longToNumber(reader.int64() as Long);
          continue;
        case 35:
          if (tag !== 280) {
            break;
          ...
          message.ReferralAmount = longToNumber(reader.int64() as Long);
          continue;
        case 36:
          if (tag !== 290) {
            break;
...
export const AlpacaCryptoKeychain = {
  ...
  create<I extends Exact<DeepPartial<AlpacaCryptoKeychain>, I>>(base?: I): AlpacaCryptoKeychain {
    return AlpacaCryptoKeychain.fromPartial(base ?? ({} as any));
  },
