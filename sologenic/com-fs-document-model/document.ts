...
function createBaseSignedDocuments(): SignedDocuments {
  return { SignedDocuments: [] };
}

export const SignedDocuments = {
  encode(message: SignedDocuments, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.SignedDocuments) {
      SignedDocument.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  ...
  create<I extends Exact<DeepPartial<SignedDocuments>, I>>(base?: I): SignedDocuments {
    return SignedDocuments.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SignedDocuments>, I>>(object: I): SignedDocuments {
    const message = createBaseSignedDocuments();
    message.SignedDocuments = object.SignedDocuments?.map((e) => SignedDocument.fromPartial(e)) || [];
    return message;
  },
