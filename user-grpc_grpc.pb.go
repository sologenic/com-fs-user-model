...
const (
	...
	UserService_UpdateReferralStats_FullMethodName = "/user.UserService/UpdateReferralStats"
)
...
type UserServiceClient interface {
	...
	UpdateReferralStats(ctx context.Context, in *ReferralStatsUpdate, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *userServiceClient) UpdateReferralStats(ctx context.Context, in *ReferralStatsUpdate, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, UserService_UpdateReferralStats_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	UpdateReferralStats(context.Context, *ReferralStatsUpdate) (*emptypb.Empty, error)
}
...
func (UnimplementedUserServiceServer) UpdateReferralStats(context.Context, *ReferralStatsUpdate) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateReferralStats not implemented")
}
...
func _UserService_UpdateReferralStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReferralStatsUpdate)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).UpdateReferralStats(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_UpdateReferralStats_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).UpdateReferralStats(ctx, req.(*ReferralStatsUpdate))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateReferralStats",
			Handler:    _UserService_UpdateReferralStats_Handler,
		},
	},
