...
const file_user_proto_rawDesc = "" +
	...
	".role.RoleR\x04Role\x12J\n" +
	"\fTradeProfile\x18\x10 \x01(\v2!.tradeprofile.TradeProfileDetailsH\x01R\fTradeProfile\x88\x01\x01\x12\"\n" +
	...
	"\tKYCStatus\x18\x14 \x01(\x0e2\x0f.user.KYCStatusR\tKYCStatus\x12O\n" +
	"\x10UserTradeProfile\x18\x15 \x01(\v2\x1e.tradeprofile.UserTradeProfileH\x02R\x10UserTradeProfile\x88\x01\x01\x12;\n" +
	"\x0eBrokerAccounts\x18\x17 \x03(\v2\x13.user.BrokerAccountR\x0eBrokerAccounts\x129\n" +
	"\fBankAccounts\x18\x18 \x03(\v2\x11.user.BankAccountB\x02\x18\x01R\fBankAccounts\x120\n" +
	"\n" +
	"UISettings\x18\x19 \x01(\v2\x10.user.UISettingsR\n" +
	"UISettings\x12S\n" +
	"\x12CommissionSettings\x18\x1a \x01(\v2\x1e.commission.CommissionSettingsH\x03R\x12CommissionSettings\x88\x01\x01\x12G\n" +
	"\x10DataFeedAccounts\x18\x1b \x01(\v2\x16.user.DataFeedAccountsH\x04R\x10DataFeedAccounts\x88\x01\x01\x122\n" +
	"\x14AllowedJurisdictions\x18\x1c \x03(\tR\x14AllowedJurisdictions\x12\"\n" +
	"\fEmailAddress\x18\x1d \x01(\tR\fEmailAddress\x12V\n" +
	...
	"\x11ADMIN_DEACTIVATED\x10\x02\x12\x16\n" +
	"\x0eTO_BE_APPROVED\x10\x03\x1a\x02\b\x01*\x9d\x01\n" +
	"\n" +
	"SocialType\x12\x17\n" +
