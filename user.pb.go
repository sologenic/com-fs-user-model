...
const file_user_proto_rawDesc = "" +
	...
	"\x12KYCStatusUpdatedAt\x18) \x01(\v2\x1a.google.protobuf.TimestampR\x12KYCStatusUpdatedAt\x12R\n" +
...
var file_user_proto_goTypes = []any{
	...
	(*AlpacaCryptoKeychain)(nil),   // 12: user.AlpacaCryptoKeychain
	(*Wallet)(nil),                 // 13: user.Wallet
	(language.Lang)(0),             // 14: language.Lang
	(role.Role)(0),                 // 15: role.Role
	(*com_fs_trade_profile_model.TradeProfileDetails)(nil), // 16: tradeprofile.TradeProfileDetails
	(*UserKYCDetails)(nil),                                 // 17: user.UserKYCDetails
	(*com_fs_document_model.UserDocumentCompliance)(nil),   // 18: document.UserDocumentCompliance
	(KYCStatus)(0),                // 19: user.KYCStatus
	(*timestamppb.Timestamp)(nil), // 20: google.protobuf.Timestamp
	(*com_fs_trade_profile_model.UserTradeProfile)(nil),  // 21: tradeprofile.UserTradeProfile
	(*BrokerAccount)(nil),                                // 22: user.BrokerAccount
...
var file_user_proto_depIdxs = []int32{
	...
	13, // 1: user.UserDetails.Wallets:type_name -> user.Wallet
	6,  // 2: user.UserDetails.Socials:type_name -> user.Social
	14, // 3: user.UserDetails.Language:type_name -> language.Lang
	15, // 4: user.UserDetails.Role:type_name -> role.Role
	16, // 5: user.UserDetails.TradeProfile:type_name -> tradeprofile.TradeProfileDetails
	17, // 6: user.UserDetails.KYCDetails:type_name -> user.UserKYCDetails
	18, // 7: user.UserDetails.UserDocumentCompliance:type_name -> document.UserDocumentCompliance
	...
	21, // 10: user.UserDetails.UserTradeProfile:type_name -> tradeprofile.UserTradeProfile
	22, // 11: user.UserDetails.BrokerAccounts:type_name -> user.BrokerAccount
	9,  // 12: user.UserDetails.UISettings:type_name -> user.UISettings
	23, // 13: user.UserDetails.CommissionSettings:type_name -> commission.CommissionSettings
	10, // 14: user.UserDetails.DataFeedAccounts:type_name -> user.DataFeedAccounts
	24, // 15: user.UserDetails.ComplianceFormAnswers:type_name -> compliance.ComplianceFormAnswer
