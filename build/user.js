...
export const UserDetails = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.ReferralAmount !== undefined) {
            writer.uint32(280).int64(message.ReferralAmount);
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 35:
                    ...
                    message.ReferralAmount = longToNumber(reader.int64());
                    continue;
                case 36:
                    if (tag !== 290) {
                        break;
    ...
    fromJSON(object) {
        return {
            ...
            ReferralProgramRewardMultiplier: isSet(object.ReferralProgramRewardMultiplier)
                ...
                : 0,
            AlpacaCryptoKeychains: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.AlpacaCryptoKeychains)
                ? object.AlpacaCryptoKeychains.map((e) => AlpacaCryptoKeychain.fromJSON(e))
                : [],
    ...
    toJSON(message) {
        ...
        if ((_e = message.AllowedJurisdictions) === null || _e === void 0 ? void 0 : _e.length) {
            obj.AllowedJurisdictions = message.AllowedJurisdictions;
        }
        if (message.EmailAddress !== "") {
            obj.EmailAddress = message.EmailAddress;
        }
        if ((_f = message.ComplianceFormAnswers) === null || _f === void 0 ? void 0 : _f.length) {
        ...
        if ((_h = message.AlpacaCryptoKeychains) === null || _h === void 0 ? void 0 : _h.length) {
    ...
    fromPartial(object) {
        ...
        message.KYCIsFederated = (_w = object.KYCIsFederated) !== null && _w !== void 0 ? _w : false;
        message.UserTradeProfile = (object.UserTradeProfile !== undefined && object.UserTradeProfile !== null)
            ...
            : undefined;
        message.BrokerAccounts = ((_x = object.BrokerAccounts) === null || _x === void 0 ? void 0 : _x.map((e) => BrokerAccount.fromPartial(e))) || [];
        ...
        message.DataFeedAccounts = (object.DataFeedAccounts !== undefined && object.DataFeedAccounts !== null)
            ...
            : undefined;
        message.AllowedJurisdictions = ((_y = object.AllowedJurisdictions) === null || _y === void 0 ? void 0 : _y.map((e) => e)) || [];
        message.EmailAddress = (_z = object.EmailAddress) !== null && _z !== void 0 ? _z : "";
        message.ComplianceFormAnswers = ((_0 = object.ComplianceFormAnswers) === null || _0 === void 0 ? void 0 : _0.map((e) => ComplianceFormAnswer.fromPartial(e))) || [];
        message.ReferredBy = (_1 = object.ReferredBy) !== null && _1 !== void 0 ? _1 : undefined;
        message.ReferralCount = (_2 = object.ReferralCount) !== null && _2 !== void 0 ? _2 : undefined;
        message.ReferralLimit = (_3 = object.ReferralLimit) !== null && _3 !== void 0 ? _3 : undefined;
        message.ReferralAmountReceived = (_4 = object.ReferralAmountReceived) !== null && _4 !== void 0 ? _4 : undefined;
        message.ReferralAmount = (_5 = object.ReferralAmount) !== null && _5 !== void 0 ? _5 : undefined;
        message.ReferralPaidAt = (_6 = object.ReferralPaidAt) !== null && _6 !== void 0 ? _6 : undefined;
        message.XHandle = (_7 = object.XHandle) !== null && _7 !== void 0 ? _7 : undefined;
        message.EliteClubMembershipStatus = (_8 = object.EliteClubMembershipStatus) !== null && _8 !== void 0 ? _8 : 0;
        message.FCMPushTokens = ((_9 = object.FCMPushTokens) === null || _9 === void 0 ? void 0 : _9.map((e) => e)) || [];
        message.ReferralProgramRewardMultiplier = (_10 = object.ReferralProgramRewardMultiplier) !== null && _10 !== void 0 ? _10 : 0;
        message.AlpacaCryptoKeychains = ((_11 = object.AlpacaCryptoKeychains) === null || _11 === void 0 ? void 0 : _11.map((e) => AlpacaCryptoKeychain.fromPartial(e))) || [];
...
function createBaseDataFeedAccounts() {
...
export const DataFeedAccounts = {
    ...
    create(base) {
        return DataFeedAccounts.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseDataFeedAccounts();
...
export const DxFeed = {
    ...
    create(base) {
        return DxFeed.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseDxFeed();
...
export const AlpacaCryptoKeychain = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.PrivateKeyHex !== "") {
            writer.uint32(26).string(message.PrivateKeyHex);
        }
        if (message.SymmetricKeyHex !== "") {
            writer.uint32(34).string(message.SymmetricKeyHex);
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    message.PrivateKeyHex = reader.string();
                    continue;
                case 4:
                    if (tag !== 34) {
                        break;
                    }
                    message.SymmetricKeyHex = reader.string();
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    toJSON(message) {
        ...
        if (message.PrivateKeyHex !== "") {
            obj.PrivateKeyHex = message.PrivateKeyHex;
        }
        if (message.SymmetricKeyHex !== "") {
            obj.SymmetricKeyHex = message.SymmetricKeyHex;
        }
        return obj;
    },
    create(base) {
        return AlpacaCryptoKeychain.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseAlpacaCryptoKeychain();
