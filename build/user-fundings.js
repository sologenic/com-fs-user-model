...
function createBaseWallet() {
    return { Address: "", Alias: "", Type: 0, SignerType: 0, Organizations: [], RegisteredSmartContracts: [] };
}
export const Wallet = {
    ...
    toJSON(message) {
        ...
        if ((_b = message.RegisteredSmartContracts) === null || _b === void 0 ? void 0 : _b.length) {
    ...
    fromPartial(object) {
        ...
        message.RegisteredSmartContracts = ((_f = object.RegisteredSmartContracts) === null || _f === void 0 ? void 0 : _f.map((e) => e)) || [];
        return message;
    },
};
