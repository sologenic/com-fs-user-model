...
function createBaseFile() {
    return { Reference: "", Name: undefined, MD5SUM: "" };
}
export const File = {
    encode(message, writer = _m0.Writer.create()) {
    ...
    fromPartial(object) {
        ...
        message.MD5SUM = (_c = object.MD5SUM) !== null && _c !== void 0 ? _c : "";
        return message;
    },
};
...
function createBaseSignedDocuments() {
    return { SignedDocuments: [] };
}
export const SignedDocuments = {
    ...
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseSignedDocuments();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return SignedDocuments.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseSignedDocuments();
